...
This project is indexed by GitNexus as **Nano-Banana-Helper** (109 symbols, 101 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
