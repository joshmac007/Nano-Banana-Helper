...
struct AspectRatio: Identifiable, Hashable, Sendable {
    ...
    nonisolated static let all: [AspectRatio] = [
        ...
        AspectRatio(id: "3:1", displayName: "3:1", category: .landscape, width: 3, height: 1),
        AspectRatio(id: "4:1", displayName: "4:1", category: .landscape, width: 4, height: 1),
        AspectRatio(id: "8:1", displayName: "8:1", category: .landscape, width: 8, height: 1),
        ...
        AspectRatio(id: "1:3", displayName: "1:3", category: .portrait, width: 1, height: 3),
        AspectRatio(id: "1:4", displayName: "1:4", category: .portrait, width: 1, height: 4),
        AspectRatio(id: "1:8", displayName: "1:8", category: .portrait, width: 1, height: 8)
    ]
